...
export default function Header() {
  return (
    <>
      <header className="w-full px-16 py-4 flex items-center text-gray-700 justify-center bg-blue-400 font-semibold fixed top-0 left-0 border-b-4 border-b-red-400">
