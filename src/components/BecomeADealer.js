...
export default function BecomeADealer({ rightArrow }) {
  return (
    <div className="flex-col-reverse sm:mt-8 bg-carImg bg-cover bg-center bg-no-repeat px-8 md:px-24 h-screen flex md:items-center text-gray-800 md:flex-row">
      <div className="w-full sm:mt-8  md:w-1/2 flex flex-col items-start md:ml-8">
        ...
        <p className="md:text-2xl text-gray-600 font-semibold">
          n Let us help your business reach new heights, sign-up and join a
